...
public class MainActivity extends AppCompatActivity {
	...
	private RecognitionListener recognitionListener = new RecognitionListener() {
		...
		public void onResults(Bundle bundle) {
			...
			((LinearLayout) findViewById(R.id.serchui)).animate().alpha(1).setDuration(500).start();
				...
				public void run() {
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							((LinearLayout) findViewById(R.id.serchui)).animate().alpha(0).setDuration(500).start();
						}
					});
				}
			}, 3000);
